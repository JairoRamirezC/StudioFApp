import { itemsRightAccessories } from "../../../../common/utils/NewItemsRightInfo"
import { SubmenusProps } from "../../../../common/utils/types"
import SubmenuItemsRight from "../submenu-items-right/SubmenuItemsRight"

const Accessories = ({handleMouseLeave}:SubmenusProps) => {
  return (
    <div onMouseLeave={handleMouseLeave} className='submenu__container'>
      ...
      <SubmenuItemsRight title='CATEGORIAS DESTACADAS' imageInfo={itemsRightAccessories} />
    </div>
  )
}
